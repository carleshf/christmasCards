...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Mc202526", create);

		#if (js && html5)
		#if (munit || (utest && openfl_enable_utest_legacy_mode))
		lime.system.System.embed("Mc202526", null, 0, 0);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "Mc202526";
		app.meta["name"] = "Mc202526";
		app.meta["packageName"] = "com.sample.mc202526";
